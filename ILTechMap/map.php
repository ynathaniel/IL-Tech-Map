...
<script src="js/jquery-1.10.2.js"></script>
    ...
    <script type="text/javascript" id="rbox-loader-script"></script>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="tagline tagline-aid" style="padding-top: 140px">
                    The Map</h1>
                </div>
            </div>
        </div>
...
<div class="width" style="height: 0px">
